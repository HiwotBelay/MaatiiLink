...
const API_ROUTE_RULES: RouteRule[] = [
  ...
  { pattern: /^\/api\/eod$/, methods: ["POST"], permission: Permission.EOD_DRAFT },
  { pattern: /^\/api\/eod/, methods: ["GET"], permission: Permission.EOD_VIEW_BRANCH },
  ...
  { pattern: /^\/api\/incidents\/[^/]+\/attachments$/, methods: ["POST"], permission: Permission.INCIDENT_CREATE },
  { pattern: /^\/api\/incidents\/[^/]+$/, methods: ["PATCH"], permission: Permission.INCIDENT_UPDATE },
  { pattern: /^\/api\/incidents\/[^/]+$/, methods: ["GET"], permission: Permission.INCIDENT_VIEW_BRANCH },
